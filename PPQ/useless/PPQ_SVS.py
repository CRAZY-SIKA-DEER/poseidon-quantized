"""
Calibrate the Poseidon NS-SVS model with Probabilistic Programming Quantisation (PPQ).

Usage example:
python -m PPQ.PPQ_SVS \
    --model-dir models/NS-SVS \
    --dataset-dir dataset/NS-SVS \
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run PPQ calibration on the NS-SVS Poseidon model.")
    parser.add_argument("--model-dir", type=Path, default=Path("models/NS-SVS"), help="Directory with config.json & pytorch_model.bin.")
    parser.add_argument("--dataset-dir", type=Path, default=Path("dataset/NS-SVS"), help="Directory containing NS-SVS.nc files.")
    ...
    parser.add_argument("--gamma", type=float, default=0.004, help="MDL prior strength.")
