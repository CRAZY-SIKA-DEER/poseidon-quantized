# SAPQ/run_sapq_network_global.py is the version that uses frozen calibration dataset, this old version does not use that
...
def main():
    ...
    out_dir = Path(cfg.repo_root) / "SAPQ" / "artifacts_global" / Path(cfg.model_path).name
