...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_L_NS-SVS_2048.yaml",
    "--wandb_run_name", "finetune_NS-SVS_run_L_2048",
    "--wandb_project_name", "PoseidonFinetune_NS-SVS_L",
    "--checkpoint_path", "checkpoints/finetune_NS-SVS_L_2048",
