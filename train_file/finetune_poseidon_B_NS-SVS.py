...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_B_NS-SVS_2048.yaml",
    "--wandb_run_name", "finetune_NS-SVS_run_B_2048",
    "--wandb_project_name", "PoseidonFinetune_NS-SVS_B",
    "--checkpoint_path", "checkpoints/finetune_NS-SVS_B_2048",
