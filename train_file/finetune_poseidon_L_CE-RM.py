...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_L_CE-RM.yaml",
    "--wandb_run_name", "finetune_CE-RM_run_L",
    "--wandb_project_name", "PoseidonFinetune_CE-RM_L",
    "--checkpoint_path", "checkpoints/finetune_CE-RM_L",
