...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_B_NS-PwC_2048.yaml",
    "--wandb_run_name", "finetune_NS-PwC_run_B_2048",
    "--wandb_project_name", "PoseidonFinetune_NS-PwC_B",
    "--checkpoint_path", "checkpoints/finetune_NS-PwC_B_2048",
