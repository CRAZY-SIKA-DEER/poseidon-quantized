...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_L_NS-BB_2048.yaml",
    "--wandb_run_name", "finetune_NS-BB_run_L_2048",
    "--wandb_project_name", "PoseidonFinetune_NS-BB_L",
    "--checkpoint_path", "checkpoints/finetune_NS-BB_L_2048",
