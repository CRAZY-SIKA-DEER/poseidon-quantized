...
command = [
    "accelerate", "launch",
    "scOT/train.py",
    "--config", "configs/run_B_GCE-RT.yaml",
    "--wandb_run_name", "finetune_GCE-RT_run_B",
    "--wandb_project_name", "PoseidonFinetune_GCE-RT_B",
    "--checkpoint_path", "checkpoints/finetune_GCE-RT_B",
