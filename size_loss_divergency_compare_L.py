...
#model path
#NS-PwC-L
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-PwC_L/PoseidonFinetune_NS-PwC_L/finetune_NS-PwC_run_L"
#NS-SVS-B
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SVS_L/PoseidonFinetune_NS-SVS_L/finetune_NS-SVS_run_L"
#NS-BB-B
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-BB_L/PoseidonFinetune_NS-BB_L/finetune_NS-BB_run_L"
#NS-SL
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SL_L/PoseidonFinetune_NS-SL_L/finetune_NS-SL_run_L/checkpoint-34560"
#NS-PwC-B_2048
...
#NS-BB-B_2048
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-BB_B_2048/PoseidonFinetune_NS-BB_B/finetune_NS-BB_run_B_2048/checkpoint-368800"
#NS-SL-B_2048
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SL_B_2048/PoseidonFinetune_NS-SL_B/finetune_NS-SL_run_B_2048/checkpoint-368800"
#NS-SVS-B_2048
FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SVS_B_2048/PoseidonFinetune_NS-SVS_B/finetune_NS-SVS_run_B_2048/checkpoint-368800"
#NS-PwC-L_2048
...
#NS-BB-L_2048
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-BB_L_2048/PoseidonFinetune_NS-BB_L/finetune_NS-BB_run_L_2048/checkpoint-368800"
#NS-SL-L_2048
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SL_L_2048/PoseidonFinetune_NS-SL_L/finetune_NS-SL_run_L_2048/checkpoint-368800"
#NS-SVS-L_2048
#FLOAT_MODEL_PATH = "checkpoints/finetune_NS-SVS_L_2048/PoseidonFinetune_NS-SVS_L/finetune_NS-SVS_run_L_2048/checkpoint-368800"


#quantized model path
#QAT_MODEL_PATH   = "qat_int8_poseidon_NS-PwC_L.pt"
#QAT_MODEL_PATH   = "qat_int8_poseidon_NS-SVS_L.pt"
#QAT_MODEL_PATH   = "qat_int8_poseidon_NS-BB_L.pt"
#QAT_MODEL_PATH   = "QAT/qat_int8_poseidon_NS-PwC_L_2048.pt"
#QAT_MODEL_PATH   = "QAT/qat_int8_poseidon_NS-PwC_B_2048.pt"
#QAT_MODEL_PATH   = "QAT/qat_int8_poseidon_NS-PwC_L_2048_divergency_free.pt"
#QAT_MODEL_PATH   = "QAT/qat_int8_poseidon_NS-PwC_B_2048_divergency_free.pt"
#QAT_MODEL_PATH   = "QAT/qat_int8_poseidon_NS-BB_L_2048.pt"
QAT_MODEL_PATH   = "QAT/QAT-L/SVS/qat_ckpt_best.pt"
    ...
    with torch.no_grad():
        for batch in dl:
            ...
            # all_preds.append(preds.cpu())
                        # tell the model to compute its own loss for us,
            # and get back both loss and prediction:
            output = model(
                pixel_values=xb,
                time=tm,
                labels=yb,
            ...
            # ScOTOutput: .loss is mean per‐element over the batch
            loss  = output.loss
            preds = output.output

            # accumulate element‐weighted loss
            n_elems = preds.numel()
